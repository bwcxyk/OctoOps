...
func RegisterBatchTaskRoutes(r *gin.RouterGroup) {
	r.GET("/seatunnel/batch", ListTasks)
	r.POST("/seatunnel/batch", CreateTask)
	r.PUT("/seatunnel/batch/:id", UpdateTaskWithScheduler)
	r.DELETE("/seatunnel/batch/:id", DeleteTask)
}
