...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'tasklog', component: () => import('./views/TaskLog.vue'), name: 'TaskLog', meta: { permission: 'task:log' } },
      { path: 'ecs-security-group', component: () => import('./views/aliyun/EcsSecurityGroup.vue'), name: 'EcsSecurityGroup', meta: { permission: 'aliyun:ecs_sg' } },
