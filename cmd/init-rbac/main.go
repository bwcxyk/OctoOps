...
func createMenuLikePermissions() map[string]*model.Permission {
	...
	permissions := []model.Permission{
		// 阿里云
		{Name: "ECS安全组查看", Code: "aliyun:ecs_sg:read", Description: "查看ECS安全组", Type: "api", Path: "/api/aliyun-sg-configs", Method: "GET", Status: 1, ParentID: subMenuMap["aliyun:ecs_sg"].ID},
		{Name: "ECS安全组创建", Code: "aliyun:ecs_sg:create", Description: "创建ECS安全组", Type: "api", Path: "/api/aliyun-sg-configs", Method: "POST", Status: 1, ParentID: subMenuMap["aliyun:ecs_sg"].ID},
		{Name: "ECS安全组更新", Code: "aliyun:ecs_sg:update", Description: "更新ECS安全组", Type: "api", Path: "/api/aliyun-sg-configs/:id", Method: "PUT", Status: 1, ParentID: subMenuMap["aliyun:ecs_sg"].ID},
		{Name: "ECS安全组删除", Code: "aliyun:ecs_sg:delete", Description: "删除ECS安全组", Type: "api", Path: "/api/aliyun-sg-configs/:id", Method: "DELETE", Status: 1, ParentID: subMenuMap["aliyun:ecs_sg"].ID},
		// Seatunnel
		{Name: "实时数据集成查看", Code: "etl:stream:read", Description: "查看实时数据集成", Type: "api", Path: "/api/tasks", Method: "GET", Status: 1, ParentID: subMenuMap["etl:stream"].ID},
		{Name: "实时数据集成创建", Code: "etl:stream:create", Description: "创建实时数据集成", Type: "api", Path: "/api/tasks", Method: "POST", Status: 1, ParentID: subMenuMap["etl:stream"].ID},
		{Name: "实时数据集成更新", Code: "etl:stream:update", Description: "更新实时数据集成", Type: "api", Path: "/api/tasks/:id", Method: "PUT", Status: 1, ParentID: subMenuMap["etl:stream"].ID},
		{Name: "实时数据集成删除", Code: "etl:stream:delete", Description: "删除实时数据集成", Type: "api", Path: "/api/tasks/:id", Method: "DELETE", Status: 1, ParentID: subMenuMap["etl:stream"].ID},
		{Name: "离线数据集成查看", Code: "etl:batch:read", Description: "查看离线数据集成", Type: "api", Path: "/api/tasks", Method: "GET", Status: 1, ParentID: subMenuMap["etl:batch"].ID},
		{Name: "离线数据集成创建", Code: "etl:batch:create", Description: "创建离线数据集成", Type: "api", Path: "/api/tasks", Method: "POST", Status: 1, ParentID: subMenuMap["etl:batch"].ID},
		{Name: "离线数据集成更新", Code: "etl:batch:update", Description: "更新离线数据集成", Type: "api", Path: "/api/tasks/:id", Method: "PUT", Status: 1, ParentID: subMenuMap["etl:batch"].ID},
		{Name: "离线数据集成删除", Code: "etl:batch:delete", Description: "删除离线数据集成", Type: "api", Path: "/api/tasks/:id", Method: "DELETE", Status: 1, ParentID: subMenuMap["etl:batch"].ID},
		// 任务管理
		...
		{Name: "自定义任务查看", Code: "task:schedule:read", Description: "查看自定义任务", Type: "api", Path: "/api/custom-tasks", Method: "GET", Status: 1, ParentID: subMenuMap["task:schedule"].ID},
		{Name: "任务日志查看", Code: "task:log:read", Description: "查看任务日志", Type: "api", Path: "/api/task-logs", Method: "GET", Status: 1, ParentID: subMenuMap["task:log"].ID},
		// 告警管理
		{Name: "告警组管理查看", Code: "notify:group:read", Description: "查看告警组", Type: "api", Path: "/api/alert-groups", Method: "GET", Status: 1, ParentID: subMenuMap["notify:group"].ID},
		{Name: "告警组管理创建", Code: "notify:group:create", Description: "创建告警组", Type: "api", Path: "/api/alert-groups", Method: "POST", Status: 1, ParentID: subMenuMap["notify:group"].ID},
		{Name: "告警组管理更新", Code: "notify:group:update", Description: "更新告警组", Type: "api", Path: "/api/alert-groups/:id", Method: "PUT", Status: 1, ParentID: subMenuMap["notify:group"].ID},
		{Name: "告警组管理删除", Code: "notify:group:delete", Description: "删除告警组", Type: "api", Path: "/api/alert-groups/:id", Method: "DELETE", Status: 1, ParentID: subMenuMap["notify:group"].ID},
		{Name: "告警模板查看", Code: "notify:template:read", Description: "查看告警模板", Type: "api", Path: "/api/alert-templates", Method: "GET", Status: 1, ParentID: subMenuMap["notify:template"].ID},
		{Name: "告警模板创建", Code: "notify:template:create", Description: "创建告警模板", Type: "api", Path: "/api/alert-templates", Method: "POST", Status: 1, ParentID: subMenuMap["notify:template"].ID},
		{Name: "告警模板更新", Code: "notify:template:update", Description: "更新告警模板", Type: "api", Path: "/api/alert-templates/:id", Method: "PUT", Status: 1, ParentID: subMenuMap["notify:template"].ID},
		{Name: "告警模板删除", Code: "notify:template:delete", Description: "删除告警模板", Type: "api", Path: "/api/alert-templates/:id", Method: "DELETE", Status: 1, ParentID: subMenuMap["notify:template"].ID},
		{Name: "告警渠道查看", Code: "notify:channel:read", Description: "查看告警渠道", Type: "api", Path: "/api/channels", Method: "GET", Status: 1, ParentID: subMenuMap["notify:channel"].ID},
		{Name: "告警渠道创建", Code: "notify:channel:create", Description: "创建告警渠道", Type: "api", Path: "/api/channels", Method: "POST", Status: 1, ParentID: subMenuMap["notify:channel"].ID},
		{Name: "告警渠道更新", Code: "notify:channel:update", Description: "更新告警渠道", Type: "api", Path: "/api/channels/:id", Method: "PUT", Status: 1, ParentID: subMenuMap["notify:channel"].ID},
		{Name: "告警渠道删除", Code: "notify:channel:delete", Description: "删除告警渠道", Type: "api", Path: "/api/channels/:id", Method: "DELETE", Status: 1, ParentID: subMenuMap["notify:channel"].ID},
		// 用户管理
...
func assignPermissionsToRoles(roles map[string]*model.Role, permissions map[string]*model.Permission) {
	...
	if operator, exists := roles["操作员"]; exists {
		operatorPermissions := []string{
			...
			// Seatunnel
			"etl:stream:read", "etl:stream:create", "etl:stream:update", "etl:batch:read", "etl:batch:create", "etl:batch:update",
			// 任务管理
