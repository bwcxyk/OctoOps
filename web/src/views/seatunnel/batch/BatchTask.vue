<template>
  <el-card>
    ...
    <!-- 操作按钮区域 -->
    <el-button type="primary" @click="goToNewTask" style="margin-bottom: 12px;">新增</el-button>
    ...
    />
    <el-dialog v-model="dialogVisible" :title="editTask.id ? '编辑作业' : '新建作业'" width="80%" :close-on-click-modal="false">
