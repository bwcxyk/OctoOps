<template>
  <div>
    <el-card>
      <div style="margin-bottom: 16px; display: flex; justify-content: flex-start; align-items: center; gap: 12px;">
...
ecs:DescribeSecurityGroupAttribute
      ...
      <el-dialog v-model="dialogVisible" :title="editConfig.id ? '编辑配置' : '新增配置'" width="500px" :close-on-click-modal="false">
